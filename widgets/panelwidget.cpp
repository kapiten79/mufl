      ...
      panelSide(std::move(std::move(p_panelSide)))
{
    try {
        ...
        qDebug() << "Исключение возникло в методе PanelWidget класса PanelWidget " << error.what();
    }
}
...
void PanelWidget::setPanelType(ViewType panelType)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе setPanelType класса PanelWidget " << error.what();
    }
...
void PanelWidget::setCurrPath(const QString& path, const QString& pathToSet)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе setCurrPath класса PanelWidget " << error.what();
    }
}
...
QString PanelWidget::getRightsStringFile(const QFileInfo& fileInfo)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе getRightsStringFile класса PanelWidget " << error.what();
    }
    return QString();
}
...
QString PanelWidget::getRightsStringPath(const QFileInfo& pathInfo)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе getRightsStringPath класса PanelWidget " << error.what();
    }
    return QString();
}
...
void PanelWidget::createTable()
{
    try {
        ...
        qDebug() << "Исключение возникло в методе createTable класса PanelWidget " << error.what();
    }
...
void PanelWidget::openFile(const QString& fileName)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе openFile класса PanelWidget " << error.what();
    }
...
void PanelWidget::updatePanel(const QString& pathName)
{
    try {
        ...
        qDebug() << "Исключение возникло в методе updatePanel класса PanelWidget " << error.what();
    }
}
